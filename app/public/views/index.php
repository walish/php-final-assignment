      ...
      <?php if ($news == null) {?>
            <form action="migrate" method='POST'>
              <div class="form-group " style="text-align:center">
                ...
                <button type="submit" class="btn btn-primary" name='init_data'>Crawl data</button>
              </div>
            </form>
      <?php } else {?>
            <form action="migrate" method='POST'>
            ...
            <form method='POST'>
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Search" name="search">
              </div>
